      ...
      <Router>
        <ErrorBoundary>
          <Switch>
            ...
            <Route path="/student/login" component={StudentLogin} /> {/* Student login */}
            <RoleRoute path="/student/dashboard" component={StudentDashboard} />  {/* Student's dashboard with their chapters */}
            <RoleRoute
            ...
            {/* Supervisor Routes */}
            <Route path="/supervisor/login" exact component={SupervisorLogin} />  {/* Supervisor's login */}
            <RoleRoute
            ...
            {/* Coordinator Routes */}
            <Route path="/coordinator/signup" component={CoordinatorSignup} />  {/* Coordinator Signup */}
            <Route path="/coordinator/login" component={CoordinatorLogin} />  {/* Coordinator login */}
            <RoleRoute
